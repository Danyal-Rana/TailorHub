...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-slate-50">
      <div className="w-full max-w-md bg-white rounded-3xl p-10 shadow-premium">
        ...
        {sent ? (
          ...
          <>
            ...
            <Link href="/login" className="flex items-center gap-2 text-slate-500 hover:text-brand-600 mt-6 text-sm font-medium">
